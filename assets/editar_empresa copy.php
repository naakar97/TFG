                                ...
                                <table id="personasdecontacto" class="table table-responsive table-striped display" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        try {
                                            ...
                                            SELECT a.id, a.nombre, a.nif, a.tlf, a.email
                                            FROM agenda a
                                            INNER JOIN contactos_empresa ca ON a.id = ca.id_agenda
                                                ...
                                                foreach ($contactos as $contacto) {
                                                    ...
                                                    <td style='width:5%;'>
                                                        <div class='dropdown'>
                                                            ...
                                                            <li><a href='#' class='dropdown-item' data-bs-toggle='modal'>Editar</a></li>
                                                            <li>
                                                            <a href='#' 
                                                            class='dropdown-item text-danger desvincular-contacto' 
