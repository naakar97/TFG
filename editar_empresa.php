                    ...
                    <div class="tab-pane fade" id="tab_2" role="tabpanel" aria-labelledby="traza-tab">
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-9">
                                <h5 class="mb-3 ms-3 ">Contactos</h5>
                            </div>
                            <!-- Botón para abrir el modal -->
                            <div class="col-sm-12 col-md-6 col-lg-3">
                                <button type='button' class='btn btn-primary ms-3' data-bs-toggle='modal' data-bs-target='#buscarpcontacto_<?php echo $id; ?>'>
                            ...
                            <div class="row">
                                <table id="personasdecontacto" class="table table-responsive table-striped display" cellspacing="0" width="100%">
                                    <thead>
                                        ...
                                        ");
                                        $consultaContactos->bindParam(':id_empresa', $id);
                                            ...
                                            if ($contactos) {
                                                foreach ($contactos as $contacto) {
                                                    echo "<tr>
                                                            ...
                                                            <td>" . htmlspecialchars($contacto['nif']) . "</td>
                                                            <td>" . htmlspecialchars($contacto['tlf']) . "</td>
                                                ...
                                                // Si no hay contactos, asegúrate de que la fila tenga 5 columnas
